"""Render a PNG review sheet for the requested mono font candidates."""
...
OUT = Path(
    r"C:\Users\lmadden\.codex\visualizations\2026\08\28\01a0491e-b081-7c93-a3f0-f5d76871c343\klcode-mono-font-candidate-sheet.png"
)

CANDIDATES = [
    ("Share Tech Mono Regular", "ShareTechMono-Regular.ttf"),
    ("JetBrains Mono Bold", "JetBrainsMono-Bold.ttf"),
    ("Chivo Mono Bold", "ChivoMono-Bold.ttf"),
...
def main():
    image = Image.new("RGBA", (1600, 740), (34, 34, 34, 255))
