...
- Direct imports: from pyrevit import script;from pyrevit import revit, DB;
- Local helper functions: project_number,project_name,doc_warnings,
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: output.center,output.close_others,output.print_md,output.set_title,script.get_output,
