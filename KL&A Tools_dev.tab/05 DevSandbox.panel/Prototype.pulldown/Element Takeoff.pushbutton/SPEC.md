...
- Direct imports: from pyrevit import revit, DB, forms, script;from collections import defaultdict;
- Local helper functions: _gcd,get_element_length_ft,get_element_volume_cf,ft_to_str,cf_to_cy,
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: forms.alert,output.print_md,script.get_output,
