# _Open Project Folder(DEPRECATED)
...
- Direct imports: import os;from pyrevit import revit, forms, script;from Autodesk.Revit.DB import StorageType;
- Local helper functions: get_project_info_param,prompt_for_path,open_target,
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: forms.CommandSwitchWindow,forms.alert,forms.ask_for_string,
...
Detected mutation/external-effect patterns: .Set(,revit.Transaction,
