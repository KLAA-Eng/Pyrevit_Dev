...
- Direct imports: from pyrevit import revit, forms, script;from pyrevit import DB as DB;
- Local helper functions: Top-level script flow.
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: output.close_others,output.print_md,script.get_output,
