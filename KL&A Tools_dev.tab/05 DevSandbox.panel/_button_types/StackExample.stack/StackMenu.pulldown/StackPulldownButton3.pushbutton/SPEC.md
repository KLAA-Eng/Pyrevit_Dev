...
- Direct imports: from Autodesk.Revit.DB import *;from Autodesk.Revit.DB.Architecture import Room, RoomTag;from Autodesk.Revit.UI.Selection import ObjectType, PickBoxStyle, Selection, ISelectionFilter;import clr;from System.Collections.Generic import List;from Autodesk.Revit.UI.Selection import ObjectType, ISelectionFilter;
- Local helper functions: AllowElement,__init__,AllowElement,__init__,AllowElement,AllowElement,
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: PickBoxStyle,PickElementsByRectangle,PickObject,PickObjects,
