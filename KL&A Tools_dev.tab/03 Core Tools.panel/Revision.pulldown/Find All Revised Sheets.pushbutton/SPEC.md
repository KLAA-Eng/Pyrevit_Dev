...
- Direct imports: from pyrevit import revit, DB;from pyrevit import script;
- Local helper functions: Top-level script flow.
- Bundled external assets: None.

## GUI and interaction

Static UI/API references: output.print_md,script.get_output,
